...
public static void main(String[] args) throws InterruptedException {
	...
	WebElement target1 = driver.findElement(By.xpath("//ol[@id='bank']/descendant::li"));
	
	WebElement src2 = driver.findElement(By.xpath("//a[text()=' 5000 ']"));
	WebElement target2 = driver.findElement(By.xpath("//ol[@id='amt7']/descendant::li"));
	
	WebElement src3 = driver.findElement(By.xpath("//a[text()=' SALES ']"));
	WebElement target3 = driver.findElement(By.xpath("//ol[@id='loan']/descendant::li"));
